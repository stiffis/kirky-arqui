...
\code{imem} original. Esa es la garantía de que la plomería no rompe nada.
...
%==================================================================
\section{Resumen de la Fase 0 (``plomería'')}
%==================================================================
...
\midrule
\textbf{0} & Plomería & \code{imem} ventana deslizante + \code{PCPlusInc} ($+2/+4$) + \code{decompressor.v} en \emph{passthrough}. La regresión RV32I debe seguir intacta. Es también el ``cambio extra al datapath'' que pide la rúbrica. \\
...
riesgos: todo el trabajo vive en \code{decompressor.v} y en la plomería de la
Fase 0.
...
después de esta plomería, solo rellenar el \emph{case} del descompresor según los
